...
ColorValuePicker = function(picker, color, bindedHex, alphaPrecision) {
    ...
    keyDown = function(e) {
        ...
        case blue.get(0):
            ...
            break;
        case alpha && alpha.get(0) : switch (e.keyCode) {
            case 38:
    ...
    keyUp = function(e) {
        ...
        case blue.get(0):
            ...
            color.val('b', blue.val(), e.target);
            break;
        case alpha && alpha.get(0) : alpha.val(setValueInRange.call($this, alpha.val(), 0, 100));
            color.val('a', Math.precision((alpha.val() * 255) / 100, alphaPrecision), e.target);
            break;
        case hue.get(0):
        ...
        case hex.get(0):
            ...
            break;
        case bindedHex && bindedHex.get(0) : bindedHex.val(bindedHex.val().replace(/[^a-fA-F0-9]/g, '').toLowerCase().substring(0, 6));
            hex.val(bindedHex.val());
            color.val('hex', bindedHex.val() != '' ? bindedHex.val() : null, e.target);
            break;
        case ahex && ahex.get(0) : ahex.val(ahex.val().replace(/[^a-fA-F0-9]/g, '').toLowerCase().substring(0, 2));
    ...
    blur = function(e) {
        if (color.val() != null) {
            ...
            case value.get(0):
                ...
                break;
            case hex.get(0):
            case bindedHex && bindedHex.get(0) : hex.val(color.val('hex'));
                bindedHex && bindedHex.val(color.val('hex'));
                break;
            case ahex && ahex.get(0) : ahex.val(color.val('ahex').substring(6));
                break;
            }
        }
    },
...
$.jPicker = {
    ...
    Color: function(init) {
        var $this = this,
        r, g, b, a, h, s, v, changeEvents = new Array(),
        fireChangeEvents = function(context) {
            for (var i = 0; i < changeEvents.length; i++) changeEvents[i].call($this, $this, context);
        },
        val = function(name, value, context) {
...
$.fn.jPicker = function(options) {
    ...
    return this.each(function() {
        ...
        if (settings.window.expandable) $($this).after('<span class="jPicker"><span class="Icon"><span class="Color">&nbsp;</span><span class="Alpha">&nbsp;</span><span class="Image" title="Click To Open Color Picker">&nbsp;</span><span class="Container">&nbsp;</span></span></span>');
        ...
        setColorMode = function(colorMode) {
            ...
            case 'h':
                setTimeout(function() {
                    ...
                    setImgLoc.call($this, colorMapL2, 158);
                    setAlpha.call($this, colorMapL2, 100);
                    setBG.call($this, colorBarDiv, 'transparent');
                    setImgLoc.call($this, colorBarL1, 0);
                    setAlpha.call($this, colorBarL1, 100);
                    setImgLoc.call($this, colorBarL2, 158);
                    setAlpha.call($this, colorBarL2, 100);
                    setImgLoc.call($this, colorBarL3, 158);
                    setAlpha.call($this, colorBarL3, 100);
                    setImgLoc.call($this, colorBarL4, 158);
                    setAlpha.call($this, colorBarL4, 100);
                    setImgLoc.call($this, colorBarL6, 158);
            ...
            case 's':
                setTimeout(function() {
                    setBG.call($this, colorMapDiv, 'transparent');
                    setImgLoc.call($this, colorMapL1, -158);
                    setImgLoc.call($this, colorMapL2, -316);
                    setImgLoc.call($this, colorBarL1, -158);
                    setImgLoc.call($this, colorBarL2, -316);
                    setImgLoc.call($this, colorBarL6, 158);
                    setAlpha.call($this, colorBarL6, 100);
                },
                0);
            ...
            case 'v':
                setTimeout(function() {
                    ...
                    setImgLoc.call($this, colorMapL1, -474);
                    setImgLoc.call($this, colorMapL2, 158);
                    setBG.call($this, colorBarDiv, hex);
                    setImgLoc.call($this, colorBarL1, -316);
                    setImgLoc.call($this, colorBarL2, 158);
                    setAlpha.call($this, colorBarL2, 100);
                    setImgLoc.call($this, colorBarL6, 158);
                    setAlpha.call($this, colorBarL6, 100);
            ...
            case 'b':
                setTimeout(function() {
                    ...
                    setImgLoc.call($this, colorMapL2, rgbMap - 158);
                    setImgLoc.call($this, colorBarL1, rgbBar - 474);
                    setImgLoc.call($this, colorBarL2, rgbBar - 316);
                    setImgLoc.call($this, colorBarL3, rgbBar);
                    setImgLoc.call($this, colorBarL4, rgbBar - 158);
                    setImgLoc.call($this, colorBarL6, 158);
                    setAlpha.call($this, colorBarL6, 100);
                },
                0);
        ...
        setAlpha = function(obj, alpha) {
            ...
            if (alpha > 0 && alpha < 100) {
                if (isLessThanIE7) {
                    ...
                    if (src != null && (src.indexOf('AlphaBar.png') != -1 || src.indexOf('Bars.png') != -1 || src.indexOf('Maps.png') != -1)) obj.css({
        ...
        expandableColorChanged = function(ui, context) {
            ...
            if (settings.window.bindToInput && settings.window.updateInputColor) settings.window.input.css({
                backgroundColor: hex && '#' + hex || 'transparent',
        ...
        show = function() {
            ...
            if (navigator.userAgent.toLowerCase().indexOf('chrome') > -1) $(this).fadeOut(1,
            function() {
                $(this).fadeIn(1)
            });
        },
        ...
        initialize = function() {
            ...
            var controlHtml = '<table class="jPicker" cellpadding="0" cellspacing="0"><tbody>' + (win.expandable ? '<tr><td class="Move" colspan="5">&nbsp;</td></tr>': '') + '<tr><td rowspan="10"><h2 class="Title">' + (win.title || localization.text.title) + '</h2><div class="Map"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><img src="' + images.clientPath + images.colorMap.arrow.file + '" class="Arrow"/></div></td><td rowspan="10"><div class="Bar"><span class="Map1">&nbsp;</span><span class="Map2">&nbsp;</span><span class="Map3">&nbsp;</span><span class="Map4">&nbsp;</span><span class="Map5">&nbsp;</span><span class="Map6">&nbsp;</span><img src="' + images.clientPath + images.colorBar.arrow.file + '" class="Arrow"/></div></td><td colspan="2" class="Preview">' + localization.text.newColor + '<div><span class="Active" title="' + localization.tooltips.colors.newColor + '">&nbsp;</span><span class="Current" title="' + localization.tooltips.colors.currentColor + '">&nbsp;</span></div>' + localization.text.currentColor + '</td><td rowspan="9" class="Button">Predefined colors<div class="Grid">&nbsp;</div></td></tr><tr class="Hue"><td class="Radio"><label title="' + localization.tooltips.hue.radio + '"><input type="radio" value="h"' + (settings.color.mode == 'h' ? ' checked="checked"': '') + '/>H:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.h: '') + '" title="' + localization.tooltips.hue.textbox + '"/></td></tr><tr class="Saturation hidden"><td class="Radio"><label title="' + localization.tooltips.saturation.radio + '"><input type="radio" value="s"' + (settings.color.mode == 's' ? ' checked="checked"': '') + '/>S:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.s: '') + '" title="' + localization.tooltips.saturation.textbox + '"/>&nbsp;%</td></tr><tr class="Value hidden"><td class="Radio"><label title="' + localization.tooltips.value.radio + '"><input type="radio" value="v"' + (settings.color.mode == 'v' ? ' checked="checked"': '') + '/>V:</label><br/><br/></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.v: '') + '" title="' + localization.tooltips.value.textbox + '"/>&nbsp;%<br/><br/></td></tr><tr class="Red"><td class="Radio"><label title="' + localization.tooltips.red.radio + '"><input type="radio" value="r"' + (settings.color.mode == 'r' ? ' checked="checked"': '') + '/>R:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.r: '') + '" title="' + localization.tooltips.red.textbox + '"/></td></tr><tr class="Green"><td class="Radio"><label title="' + localization.tooltips.green.radio + '"><input type="radio" value="g"' + (settings.color.mode == 'g' ? ' checked="checked"': '') + '/>G:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.g: '') + '" title="' + localization.tooltips.green.textbox + '"/></td></tr><tr class="Blue"><td class="Radio"><label title="' + localization.tooltips.blue.radio + '"><input type="radio" value="b"' + (settings.color.mode == 'b' ? ' checked="checked"': '') + '/>B:</label></td><td class="Text"><input type="text" maxlength="3" value="' + (all != null ? all.b: '') + '" title="' + localization.tooltips.blue.textbox + '"/></td></tr><tr class="Alpha"><td class="Radio">' + (win.alphaSupport ? '<label title="' + localization.tooltips.alpha.radio + '"><input type="radio" value="a"' + (settings.color.mode == 'a' ? ' checked="checked"': '') + '/>A:</label>': '&nbsp;') + '</td><td class="Text">' + (win.alphaSupport ? '<input type="text" maxlength="' + (3 + win.alphaPrecision) + '" value="' + (all != null ? Math.precision((all.a * 100) / 255, win.alphaPrecision) : '') + '" title="' + localization.tooltips.alpha.textbox + '"/>': '&nbsp;') + '</td></tr><tr class="Hex"><td colspan="2" class="Text"><label style="display:block;margin-top:2px;" title="' + localization.tooltips.hex.textbox + '">#: <input type="text" maxlength="6" class="Hex" value="' + (all != null ? all.hex: '') + '"/></label>' + (win.alphaSupport ? '<input type="text" maxlength="2" class="AHex hidden" value="' + (all != null ? all.ahex.substring(6) : '') + '" title="' + localization.tooltips.hex.alpha + '"/></td>': '&nbsp;') + '</tr><tr id="pickerbuttons"><td colspan="3" style="text-align:right;vertical-align:bottom;height:33px;"><input type="button" class="Cancel overlayButton" value="' + localization.text.cancel + '" title="' + localization.tooltips.buttons.cancel + '"/><input style="margin-left:8px;" type="button" class="Ok overlayButton jPickerDoneButton" value="' + localization.text.ok + '" title="' + localization.tooltips.buttons.ok + '"/></td></tr></tbody></table>';
            if (win.expandable) {
            ...
            pickerbuttons = tbody.find('#pickerbuttons');
            ...
            okButton = pickerbuttons.find('.Ok:first').bind('click', okClicked);
            cancelButton = pickerbuttons.find('.Cancel:first').bind('click', cancelClicked);
            ...
            if (win.expandable) {
                ...
                if (win.bindToInput && win.updateInputColor) win.input.css({
                    backgroundColor: hex && '#' + hex || 'transparent',
...
$.fn.jPicker.defaults = {
    ...
    localization: {
        ...
        tooltips: {
            colors: {
                newColor: 'New Color - Press &ldquo;Done&rdquo; To Commit',
